{{-- resources/views/post-audit-logs/index.blade.php --}}

<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">

        <div class="">
            <form action="{{ route('post-audit-logs.search') }}" method="GET">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h1 class="text-xl font-semibold">Post Audit Logs</h1>
                        ...
                        <tbody>
                            ...
                            @foreach ($logs as $log)
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">{{ $log->post->title }}</td>
